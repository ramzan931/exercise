describe('login', () => {
    it('should successfully log in with valid credentials', () => {
     cy.visit('https://www.automationexercise.com/login');
        ...
        cy.get(':nth-child(9) > a').click() //test case:6 contact us form
...
describe('search product', () => {
    it('search product and after login', () =>{
        ...
        cy.get('.nav > :nth-child(1) > a').should('be.visible') //home page should be visible
       cy.get('.shop-menu > .nav > :nth-child(6) > a').click()
       cy.get(':nth-child(8) > .panel > .panel-heading > .panel-title > a > u').click()
    })
})
   //test case :8 Verify All Products and Product detail Page
   describe('All product and product detail page', () => {
    it.only('all product and product detail page', () =>{
        cy.visit('https://www.automationexercise.com/')
